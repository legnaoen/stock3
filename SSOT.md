...
| 2024-03-21 | [작성자]    | 테마 등락률 계산 방식 변경 | 네이버 테마 지수와의 정합성 개선 |
...
### 6.1 ✅ 완료된 기능
- [x] 전체 상장종목(코스피/코스닥) 마스터 DB 구축 (PyKRX)
- [x] 업종정보 네이버 크롤링 및 StockIndustries 매핑(100% 매핑)
- [x] 테마정보 네이버 첫 페이지 크롤링 및 StockThemes 매핑(collected_at 날짜별 이력)
- [x] 업종/테마별 종목수, 매핑 현황 검증 스크립트
